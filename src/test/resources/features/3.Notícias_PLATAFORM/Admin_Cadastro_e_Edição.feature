...
Cenário: Cadastro de Notícia - Com Data de Divulgação inválida
    ...
    Quando preencher datas inválidas no campo "<Data de Divulgação>"
    E acionar o botão "Salvar"
...
@manual-last-tested:
@manual-test-evidence:[Evidência]
    Cenário: Cadastro de Notícia - Valores válidos em todos os campos
        Dado que o admin está na tela para "Cadastro de Notícias"
        ...
        E essas Notícias passam a ficar disponíveis aos usuários no banking conforme "<Ação do sistema>" e segmentação aplicada
            Exemplos:
            | Título          | Descrição | Imagem         | Vídeo                        | Data de Divulgação | Conteúdo          | Ação do sistema                                                                                                               |
            | Noticia Teste 1 | Testando  | "fazer upload" | https://youtu.be/eFTsccJ5FUo | 10/10/2022         | "Descrição longa" | Exibe a notícia para os usuários co Cargo e vinculados a(s) Revenda(s) vinculadas a(s) Rede(s) e Grupo(s) selecionado(s)      |
            | Noticia Teste 2 | Testando  | "fazer upload" | https://youtu.be/6h9mkLonA7s | 'data atual'       | "Descrição longa" | Exibe a notícia para os usuários de todas as Revendas vinculadas a(s) Grupo(s) selecionada(s)                                 |
            | Noticia Teste 3 | Testando  | "fazer upload" | https://youtu.be/k5YDRuUpVbY | 'data atual'       | "Descrição longa" | Exibe a notícia para os usuários de todas as Revendas vinculadas ao(s) Rede(s) selecionado(s)                                 |
            | Noticia Teste 4 | Testando  | "fazer upload" | https://youtu.be/_K9YV4t9dzY | 10/10/2022         | "Descrição longa" | Exibe a notícia para os usuários do(s) Cargo(s) selecionadao(s)                                                               |
            | Noticia Teste 5 | Testando  | "fazer upload" | https://youtu.be/VWAChF3RaY8 | 10/11/2022         | "Descrição longa" | Exibe a notícia para os usuários de todas as Revendas vinculadas ao(s) Grupo(s) e Rede(s) selecionada(s)                      |
            | Noticia Teste 5 | Testando  | "fazer upload" | https://youtu.be/VWAChF3RaY8 | 10/12/2022         | "Descrição longa" | Exibe a notícia para os usuários do(s) Cargo(s) selecionadao(s) e vinculado as Revenda vinculadas a(s) Rede(s) selecionada(s) |
