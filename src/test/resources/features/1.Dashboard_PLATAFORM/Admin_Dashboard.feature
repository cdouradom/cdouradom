...
Funcionalidade: Admin - Dashboard
    ...
    @manual-test-evidence:[Evidência](assets/A_dashboard-acessar-e-layout.mp4)
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_dashboard-botão-cadastrar-e-cancelar.mp4)
    Cenário: Dashboard - Botão Cadastrar e Cancelar
        Dado que o admin acessou a tela "Dashboard"
        Quando acionar o botão "Cadastrar"
        Então o sistema redireciona para a tela de cadastro com os campos "Título*" e "Link*"
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_cadastrar-dashboard-campos-vazios.mp4)
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_cadastrar-dashboard.mp4)
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_dashboard-excluir.mp4)
    Cenário: Dashboard - Excluir
        Dado que o admin está na listagem de Dashboard
        Quando acionar o botão "Ações"
        Então serão listadas as opções "Editar" e "Excluir"
        Quando acionar a opção "Excluir"
        Então o sistema exibe o modal de confirmação com os botões "Cancelar" e "Confirmar"
        ...
        Então o sistema recarrega a tela, exclui o Dashboard da campanha
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_dashboard-alterar.mp4)
    Cenário: Dashboard - Alterar
        Dado que o admin está na listagem de Dashboard
        Quando acionar o botão "Ações"
        Então serão listadas as opções "Editar" e "Excluir"
        Quando acionar a opção "Editar"
        Então o sistema redireciona para o dashboard cadastrados
