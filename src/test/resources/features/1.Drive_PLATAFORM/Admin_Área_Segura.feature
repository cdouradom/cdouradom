...
Funcionalidade: Admin - Área Segura
    Como admin aministrador ativo na Plataforma
    Quero acessar a módulos de Área Segura
    Para fazer novos cadastros de arquivos
    para disponibilizá-los no drive

    BD 'drive_file' ; 'drive_file_log'

    -----

    Critérios de Aceitação:
    Exibir breadcrumb
    Exibir os seguintes filtros:"Nome do arquivo", "Tipo", "Nome do admin", "Data início", "Data fim" e botão "Buscar"
    No filtro 'Tipo' exibir um select com as opções: "Cadastro", "Pontuação", "Relatório de pedidos", "Outros"
    No filtro 'Admin' exibir um select com os use admins da campanha
    ...
    @manual-test-evidence:[Evidência](assets/A_area-segura-acessar-e-layout.mp4)
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_area-segura-botão-upload-e-cancelar.mp4)
    Cenário: Área Segura - Botão Upload e Cancelar
        ...
        E também com o texto informativo de "*Limite de 10mb por arquivo."
        E os botões "Enviar" e "Fechar" localizado no canto superior direito
        Quando acionar o botão "Fechar"
    ...
    @manual
    @Tarefa_#60473
    @Sugestão_#60932 #aguardar
    @manual-result:failed
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_cadastrar-arquivo-campos-vazios.mp4)
    Cenário: Cadastrar Arquivo - Campos vazios
        Dado que o admin acessou a tela "Upload"
        Quando acionar o botão "Enviar"
        Mas não preencher os campos "<Selecione o Tipo>", "<Comentário>"
        E não fazer upload de arquivo em "<Selecione o Arquivo>"
        Então o sistema vai exibir a "<Mensagem do sistema>"
            | <Selecione o Tipo> | <Comentário> | <Selecione o Arquivo> | <Mensagem do sistema>       |
            |                    |              | 'fazer upload'        | Selecione o tipo do arquivo |
            | 'Pontuação'        |              |                       | Arquivo inválido            |
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_cadastrar-arquivo.mp4)
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_area-segura-baixar.mp4)
    Cenário: Área Segura - Baixar
        Dado que o admin está na listagem de "Área Segurna"
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_area-segura-filtrar.mp4)
    ...
    @manual-result:success
    @manual-last-tested:04-10-2022
    @manual-test-evidence:[Evidência](assets/A_area-segura-paginação-e-transição.mp4)
