...
@manual-test-evidence:
    Cenário: Acessos - Acessar e Layout
        ...
        Então o sistema rediciona para a tela da listagem de "Acessos"
        E os elementos abaixo serão exibidos
            | Breadcrumbs      | Com o Caminho para essa tela                            |
            | Título           | Acessos                                                 |
            | Região "Filtros" | Campos "CPF/CNPJ", "Nome", "Data inicial", "Data final" |
            | Região "Filtros" | Botão "Buscar"                                          |
            | Listagem         | Colunas "CPF/CNPJ", "Nome" e "Último Acesso"            |
...
@manual-test-evidence:
    Cenário: Acessos - Filtrar com valores existentes
        Dado que o admin esta na tela "Acessos"
        Quando preencher os filtros "<CPF/CNPJ>", "<Nome>", "<Data inicial>", "<Data final>" com valores existentes
        E clicar em "Buscar"
        ...
        E disponibiliza o botão "Exporta" no final da página
            Exemplos:
            | <CPF/CNPJ>                                         | <Nome> | <Data inicial> | <Data final>  | <Resposta do sistema>                                                                    |
...
@manual-test-evidence:
    Cenário: Acessos - Filtrar com valores NÃO existentes
        Dado que o admin esta na tela "Acessos"
        Quando preencher os filtros "<CPF/CNPJ>", "<Nome>", "<Data inicial>", "<Data final>" com valores inexistentes
        E clicar em "Buscar"
        Então o sistema exibirá na listagem conforme "<Resposta do sistema>"
        E não exibirá o texto informativo de "Foram encontrados "X" registros", pois não existe
        E NÃO disponibiliza o botão "Exportar"
        Exemplos:
            | <CPF/CNPJ>                  | <Nome> | <Data inicial> | <Data final> | <Resposta do sistema>         |
